...
/*-----------------------------------------------
              @(target):= _write_output.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__write_output

#else
#  define SWIG_init    init_write_output

#endif
#define SWIG_name    "_write_output"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_write_data_test(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
...
SWIGINTERN PyObject *_wrap_interrupts(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "interrupts" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  result = (int)interrupts(arg1);
...
SWIGINTERN PyObject *_wrap_setup(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "setup", 0, 0, 0)) SWIG_fail;
  result = (int)setup();
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
fail:
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "write_data_test", _wrap_write_data_test, METH_O, NULL},
	 { "interrupts", _wrap_interrupts, METH_O, NULL},
	 { "setup", _wrap_setup, METH_NOARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
